...
* Backend Developer at Petra Ride / Safeer InfoTech
* Experienced in REST APIs, microservices, BFF APIs, scheduled jobs, and service configuration
* Work with PostgreSQL, MySQL, DynamoDB, SQL, NoSQL, and database design
* Handle API integrations, production logs, debugging, and root-cause analysis
* AWS Cloud Practitioner certified
* Interested in backend architecture, cloud systems, automation, AI-assisted development, and prompt engineering
...
Graduation project associated with Mutah University.

Built a machine learning system using the CIC-IDS-2017 dataset to detect cyber threats and anomalies in network traffic. The project used Incremental PCA, K-Nearest Neighbors, and Random Forest models, with a focus on improving detection precision and reducing false positives.

**Tech:** Python, Machine Learning, Data Analysis, Random Forest, KNN, Incremental PCA

## Certifications

* AWS Cloud Practitioner — Amazon Web Services
* JavaScript From Scratch — Udemy
* JavaScript Master Course From Beginner to Expert Developer — Udemy
